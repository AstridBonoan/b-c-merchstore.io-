...
const accountLinks = [
  { href: "/account/orders", label: "Order history", description: "Track past and current orders." },
  { href: "/account/wishlist", label: "Wishlist", description: "Pieces you saved for later." },
  { href: "/shop", label: "Continue shopping", description: "Browse the latest drops." },
];
    ...
    <Container className="py-10 md:py-16">
      ...
      {session.role === "admin" ? (
        <div className="mt-8 rounded-2xl border border-[#0d5c63]/25 bg-[#0d5c63]/5 p-6">
          ...
          <Link href="/admin" className={cn(buttonVariants({ variant: "secondary" }), "mt-4 inline-flex")}>

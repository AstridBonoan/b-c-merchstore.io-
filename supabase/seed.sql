-- B&C Merch Store — demo seed data
...
insert into public.products (
  ...
  ('22222222-2222-2222-2222-222222222201', '11111111-1111-1111-1111-111111111101', 'B&C Classic Tee', 'bc-classic-tee',
  ...
  ('22222222-2222-2222-2222-222222222202', '11111111-1111-1111-1111-111111111101', 'B&C Essential Tee', 'bc-essential-tee',
  ...
  ('22222222-2222-2222-2222-222222222203', '11111111-1111-1111-1111-111111111101', 'B&C Signature Tee', 'bc-signature-tee',
  ...
  ('22222222-2222-2222-2222-222222222204', '11111111-1111-1111-1111-111111111102', 'B&C Core Hoodie', 'bc-core-hoodie',
  ...
  ('22222222-2222-2222-2222-222222222205', '11111111-1111-1111-1111-111111111102', 'B&C Premium Pullover', 'bc-premium-pullover',
  ...
  ('22222222-2222-2222-2222-222222222206', '11111111-1111-1111-1111-111111111102', 'B&C Tech Hoodie', 'bc-tech-hoodie',
  ...
  ('22222222-2222-2222-2222-222222222207', '11111111-1111-1111-1111-111111111103', 'B&C Classic Cap', 'bc-classic-cap',
  ...
  ('22222222-2222-2222-2222-222222222208', '11111111-1111-1111-1111-111111111103', 'B&C Snapback', 'bc-snapback',
  ...
  ('22222222-2222-2222-2222-222222222209', '11111111-1111-1111-1111-111111111103', 'B&C Embroidered Beanie', 'bc-embroidered-beanie',
  ...
  ('22222222-2222-2222-2222-222222222210', '11111111-1111-1111-1111-111111111104', 'B&C Tote Bag', 'bc-tote-bag',
  ...
  ('22222222-2222-2222-2222-222222222211', '11111111-1111-1111-1111-111111111104', 'B&C Logo Socks', 'bc-logo-socks',
  ...
  ('22222222-2222-2222-2222-222222222212', '11111111-1111-1111-1111-111111111104', 'B&C Mug', 'bc-mug',
  ...
  ('22222222-2222-2222-2222-222222222216', '11111111-1111-1111-1111-111111111104', 'B&C Key Lanyard', 'bc-key-lanyard',
...
insert into public.product_variants (
  ...
  ('44444444-4444-4444-4444-444444444001', '22222222-2222-2222-2222-222222222201', 'BC-CT-BLA-M', 'M', 'Black', '#0c0c0c', 40, true),
  ('44444444-4444-4444-4444-444444444002', '22222222-2222-2222-2222-222222222201', 'BC-CT-BNE-L', 'L', 'Bone', '#f4f4f2', 40, true),
  ('44444444-4444-4444-4444-444444444003', '22222222-2222-2222-2222-222222222201', 'BC-CT-TEL-XL', 'XL', 'Teal', '#0d5c63', 40, true),
  ('44444444-4444-4444-4444-444444444004', '22222222-2222-2222-2222-222222222202', 'BC-ET-BNE-M', 'M', 'Bone', '#f4f4f2', 55, true),
  ('44444444-4444-4444-4444-444444444005', '22222222-2222-2222-2222-222222222202', 'BC-ET-STO-L', 'L', 'Stone', '#8a857c', 55, true),
  ('44444444-4444-4444-4444-444444444006', '22222222-2222-2222-2222-222222222203', 'BC-ST-BLA-M', 'M', 'Black', '#0c0c0c', 28, true),
  ('44444444-4444-4444-4444-444444444007', '22222222-2222-2222-2222-222222222203', 'BC-ST-NAV-L', 'L', 'Navy', '#1a2332', 28, true),
  ('44444444-4444-4444-4444-444444444008', '22222222-2222-2222-2222-222222222204', 'BC-CH-BLA-L', 'L', 'Black', '#0c0c0c', 35, true),
  ('44444444-4444-4444-4444-444444444009', '22222222-2222-2222-2222-222222222204', 'BC-CH-HEA-M', 'M', 'Heather Gray', '#9b9b9b', 35, true),
  ('44444444-4444-4444-4444-444444444010', '22222222-2222-2222-2222-222222222205', 'BC-PP-BNE-M', 'M', 'Bone', '#f4f4f2', 22, true),
  ('44444444-4444-4444-4444-444444444011', '22222222-2222-2222-2222-222222222206', 'BC-TH-CHA-L', 'L', 'Charcoal', '#2f2f2f', 18, true),
  ('44444444-4444-4444-4444-444444444012', '22222222-2222-2222-2222-222222222207', 'BC-CC-BLK-OS', 'ONE_SIZE', 'Black', '#0c0c0c', 60, true),
  ('44444444-4444-4444-4444-444444444013', '22222222-2222-2222-2222-222222222207', 'BC-CC-TEL-OS', 'ONE_SIZE', 'Teal', '#0d5c63', 30, true),
  ('44444444-4444-4444-4444-444444444014', '22222222-2222-2222-2222-222222222208', 'BC-SB-BLK-OS', 'ONE_SIZE', 'Black', '#0c0c0c', 40, true),
  ('44444444-4444-4444-4444-444444444015', '22222222-2222-2222-2222-222222222209', 'BC-EB-CHR-OS', 'ONE_SIZE', 'Charcoal', '#2f2f2f', 50, true),
  ('44444444-4444-4444-4444-444444444016', '22222222-2222-2222-2222-222222222210', 'BC-TB-BNE-OS', 'ONE_SIZE', 'Bone', '#f4f4f2', 70, true),
  ('44444444-4444-4444-4444-444444444017', '22222222-2222-2222-2222-222222222211', 'BC-LS-MIX-M', 'M', 'Mixed', '#8a857c', 80, true),
  ('44444444-4444-4444-4444-444444444018', '22222222-2222-2222-2222-222222222212', 'BC-MG-BNE-OS', 'ONE_SIZE', 'Bone', '#f4f4f2', 90, true),
  ('44444444-4444-4444-4444-444444444019', '22222222-2222-2222-2222-222222222213', 'BC-CJ-BLA-M', 'M', 'Black', '#0c0c0c', 16, true),
  ('44444444-4444-4444-4444-444444444020', '22222222-2222-2222-2222-222222222214', 'BC-WS-STO-M', 'M', 'Stone', '#8a857c', 30, true),
  ('44444444-4444-4444-4444-444444444021', '22222222-2222-2222-2222-222222222215', 'BC-CP-BNE-OS', 'ONE_SIZE', 'Bone', '#f4f4f2', 38, true),
  ('44444444-4444-4444-4444-444444444022', '22222222-2222-2222-2222-222222222216', 'BC-KL-TEL-OS', 'ONE_SIZE', 'Teal', '#0d5c63', 120, true)
